...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("number_of_trades", sa.Float(), nullable=True),
    ...
    op.create_index(
        op.f("ix_trading_market_data_symbol"), "market_data", ["symbol"], unique=False, schema="trading"
    )
    op.create_index(
        op.f("ix_trading_market_data_id"), "market_data", ["id"], unique=False, schema="trading"
    )
    op.execute(
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_trading_market_data_symbol"), table_name="market_data", schema="trading")
