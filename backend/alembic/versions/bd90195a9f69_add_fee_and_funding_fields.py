...
def upgrade() -> None:
    ...
    op.add_column('accounts', sa.Column('maker_fee_bps', sa.Float(), nullable=False, server_default='5.0'), schema='trading')
    op.add_column('accounts', sa.Column('taker_fee_bps', sa.Float(), nullable=False, server_default='20.0'), schema='trading')

    # Add columns to strategy_performances table
    op.add_column('strategy_performances', sa.Column('total_fees_paid', sa.Float(), nullable=False, server_default='0.0'), schema='trading')
    op.add_column('strategy_performances', sa.Column('total_funding_paid', sa.Float(), nullable=False, server_default='0.0'), schema='trading')
    op.add_column('strategy_performances', sa.Column('total_liquidations', sa.Integer(), nullable=False, server_default='0'), schema='trading')
