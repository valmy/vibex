...
def upgrade() -> None:
    ...
    op.add_column('performance_metrics', sa.Column('max_drawdown', sa.Float(), nullable=True), schema='trading')
    op.add_column('performance_metrics', sa.Column('max_drawdown_percent', sa.Float(), nullable=True), schema='trading')
    op.add_column('performance_metrics', sa.Column('sharpe_ratio', sa.Float(), nullable=True), schema='trading')
    op.add_column('performance_metrics', sa.Column('sortino_ratio', sa.Float(), nullable=True), schema='trading')
