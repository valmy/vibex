...
from src.app.core.config import config  # Import the app's config
from src.app.models import Base  # Import all models through the main models module
...
# Add the application's target metadata
